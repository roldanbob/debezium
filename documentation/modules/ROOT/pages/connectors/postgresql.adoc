...
For more information about configuring PostgreSQL streaming replication, see the link:https://www.postgresql.org/docs/current/runtime-config-replication.html#RUNTIME-CONFIG-REPLICATION-SENDER[PostgreSQL documentation].
...
= Enabling failover slots for the PostgreSQL connector
